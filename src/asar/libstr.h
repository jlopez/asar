...
{
	char buffer[64];
	snprintf(buffer, sizeof(buffer), "%.3X", value);
	return buffer;
}
...
{
	char buffer[64];
	snprintf(buffer, sizeof(buffer), "%.4X", value);
	return buffer;
}
...
{
	char buffer[64];
	snprintf(buffer, sizeof(buffer), "%.5X", value);
	return buffer;
}
...
{
	char buffer[64];
	snprintf(buffer, sizeof(buffer), "%.6X", value);
	return buffer;
}
...
{
	char buffer[64];
	snprintf(buffer, sizeof(buffer), "%.8X", value);
	return buffer;
}
